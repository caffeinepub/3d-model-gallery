...
export class Backend implements backendInterface {
    ...
    async filterModelsByName(arg0: string): Promise<Array<Model>> {
        if (this.processError) {
            try {
                const result = await this.actor.filterModelsByName(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCategories(): Promise<Array<[string, bigint]>> {
        if (this.processError) {
            try {
    ...
    async getModel(arg0: string): Promise<Model> {
        if (this.processError) {
            try {
    ...
    async listByCategory(arg0: string): Promise<Array<Model>> {
        if (this.processError) {
            try {
    ...
    async saveModel(arg0: ModelInput): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveModel(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchModels(arg0: string): Promise<Array<Model>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchModels(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateMaterialConfig(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateMaterialConfig(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
